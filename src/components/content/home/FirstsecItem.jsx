  ...
  return (
    <NavLink key={item.id}>
              ...
              >
                ...
                />
                {item.title}
                <div onClick={updateCurrent} className=" opacity-0 group-hover:opacity-100 transition-all hover:scale-105 duration-300 absolute right-2 top-1/2 -translate-y-1/2 bg-brand-color p-[0.8rem] shadow-xl shadow-black rounded-full">
